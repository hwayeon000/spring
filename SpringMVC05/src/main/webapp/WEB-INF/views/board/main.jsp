	...
	<div class="container">
		...
		<jsp:include page="../common/header.jsp"></jsp:include>
	  	...
	  	<div class="panel panel-default">
	    	...
	    	<input type="hidden" id="name2" value="${_csrf.headerName}" >
	    	<input type="hidden" id="value2" value="${_csrf.token}">
			...
			<!-- action은 페이지를 이동하여 처리하고 돌아옴(동기방식) -->
				...
				<form id="frm">
				<input type="hidden" id="csrfHeaderName" name="${_csrf.headerName}" value="${_csrf.headerName}">
        		<input type="hidden" id="csrfTokenValue" name="${_csrf.token}" value="${_csrf.token}">
				<input id="memID" name="memID" type="hidden" value="${mvo.memID}">
					<table class="table">
						...
						<tr>
							<td>작성자</td>
							<td><input value="${mvo.memName}" readonly="readonly" id="writer" name="writer" type="text" class="form-control"></td>
						</tr>
						<tr>
							<td>내용</td>

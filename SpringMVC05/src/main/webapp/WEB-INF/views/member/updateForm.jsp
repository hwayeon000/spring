			...
			<div class="panel-body">
				<form action="${contextPath}/update.do" method="post">
					<input type="hidden" name="${_csrf.parameterName}"
						...
						name="memID" value="${mvo.memID}"> <input type="hidden"
						id="memPassword" name="memPassword" value=""> <input
						type="hidden" id="memProfile" name="memProfile"
					...
					<table class="table table-bordered"
						...
						<tr>
							...
							<td><input onkeyup="passwordCheck()" type="password"
						...
						<tr>
							...
							<td><input value="${mvo.memName}" type="text" name="memName"
								id="memName" class="form-control" placeholder="이름을 입력하세요"
								maxlength="20"></td>
						</tr>

						<tr>
							<td style="width: 110px; vertical-align: middle;">나이</td>
							<td><input required="required" value="${mvo.memAge}"
								type="number" name="memAge" id="memAge" class="form-control"
								placeholder="나이를 입력하세요" maxlength="20"></td>
						...
						<tr>
							...
							<td><input value="${mvo.memEmail}" type="email"
								" name="memEmail" id="memEmail" class="form-control"
								placeholder="이메일 입력하세요" maxlength="50"></td>
						</tr>

						<tr>
							<td style="width: 110px; vertical-align: middle;">사용자 권한</td>
							<td><input type="checkbox" name="authList[0].auth"
								value="ROLE_USER"
		                        ...
		                        <c:if test="${auth.auth eq 'ROLE_MANAGER'}">
		                           checked
										...
										ROLE_USER <input type="checkbox" name="authList[2].auth"
										value="ROLE_ADMIN"
										<c:forEach var="auth" items="${mvo.authList}">
						...
						<tr>
							<td colspan="2" style="text-align: right;">
								<!-- 비번 일치 여부 --> <span id="passMessage" style="color: red;"></span>
								<input type="submit" class="btn btn-primary btn-sm"
								value="회원정보 수정"> &nbsp;&nbsp; <input type="reset"
								class="btn btn-warning btn-sm" value="초기화"> &nbsp;&nbsp;
							</td>
						</tr>

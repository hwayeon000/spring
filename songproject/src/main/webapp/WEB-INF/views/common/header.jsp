	...
	<header class="header-v4">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="admin.do" class="flex-c-m trans-04 p-lr-25">
							admin
						</a>

						<a href="joinPage.do" class="flex-c-m trans-04 p-lr-25">
							회원가입
						</a>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="${contextPath}" class="logo">
						<img src="${contextPath}/resources/images/icons/logo-01.png" alt="IMG-LOGO">
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="product.do">상품</a>
							</li>

							<li class="label1" data-label1="hot">
								<a href="shoppingCart.do">장바구니</a>
							</li>

							<li>
								<a href="inquiry.do">문의게시판</a>
							</li>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="${contextPath}"><img src="${contextPath}/resources/images/icons/logo-01.png" alt="IMG-LOGO"></a>
			</div>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="shoping-cart.do" class="label1 rs1" data-label1="hot">Features</a>
				</li>
		...
		<div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
			<div class="container-search-header">
				<button class="flex-c-m btn-hide-modal-search trans-04 js-hide-modal-search">
					<img src="${contextPath}/resources/images/icons/icon-close2.png" alt="CLOSE">
				</button>
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="${contextPath}/resources/images/item-cart-01.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="${contextPath}/resources/images/item-cart-02.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="${contextPath}/resources/images/item-cart-03.jpg" alt="IMG">
						</div>

...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="${contextPath}fonts/iconic/css/material-design-iconic-font.min.css">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="${contextPath}fonts/linearicons-v1.0.0/icon-font.min.css">
<!--===============================================================================================-->
...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="${contextPath}vendor/slick/slick.css">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="${contextPath}vendor/MagnificPopup/magnific-popup.css">
<!--===============================================================================================-->
	...
	<section class="sec-product-detail bg0 p-t-65 p-b-60">
		<div class="container">
			<div class="row">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="${fn:split(vo.photo_path,';')[0]}">
									<div class="wrap-pic-w pos-relative">
										<img src="${fn:split(vo.photo_path,';')[0]}" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="${fn:split(vo.photo_path,';')[0]}">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="${fn:split(vo.photo_path,';')[1]}">
									<div class="wrap-pic-w pos-relative">
										<img src="${fn:split(vo.photo_path,';')[1]}" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="${fn:split(vo.photo_path,';')[1]}">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="${fn:split(vo.photo_path,';')[2]}">
									<div class="wrap-pic-w pos-relative">
										<img src="${fn:split(vo.photo_path,';')[2]}" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="${fn:split(vo.photo_path,';')[2]}">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
				...
				<c:set var="price" value="${vo.product_price}"/>
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						<h4 class="mtext-105 cl2 js-name-detail p-b-14">
							${vo.product_name}<br>
							${fn:split(vo.product_content,';')[0]}
						</h4>
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="time" onchange="changeValue(this)">
											...
											<option value="7">일주일( 7일 ) : <fmt:formatNumber value="${price}" pattern="#,###"/>원</option>
											<option value="14">이주일( 14일 ) : <fmt:formatNumber value="${price *2}" pattern="#,###"/>원</option>
											<option value="21">삼주일( 21일 ) : <fmt:formatNumber value="${price *3}" pattern="#,###"/>원</option>
											<option value="28">사주일( 28일 ) : <fmt:formatNumber value="${price *4}" pattern="#,###"/>원</option>
										</select>
									...
									<div class="p-b-30 m-lr-15-sm">
										...
										<div class="flex-w flex-t p-b-68">
											<div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
												<img src="${contextPath}/resources/images/avatar-01.jpg" alt="AVATAR">
											</div>
			...
			<div class="wrap-slick2">
				<div class="slick2">
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="${contextPath}/resources/images/product-02.jpg" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="${contextPath}/resources/images/product-03.jpg" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="${contextPath}/resources/images/product-04.jpg" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="${contextPath}/resources/images/product-05.jpg" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="${contextPath}/resources/images/product-06.jpg" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="${contextPath}/resources/images/product-07.jpg" alt="IMG-PRODUCT">
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="${contextPath}/resources/images/product-08.jpg" alt="IMG-PRODUCT">
